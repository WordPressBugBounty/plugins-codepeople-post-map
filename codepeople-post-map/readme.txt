...
* Enhanced security in the Gutenberg preview endpoint with additional authorization checks.
...
* Enhance the compatibility with latest Google Maps APIs.
...
* Load Google Maps APIs asynchronously so as not to affect website performance.
